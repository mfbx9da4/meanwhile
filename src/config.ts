export const CONFIG = {
  ...
  milestones: [
    ...
    { date: new Date(2026, 1, 5), label: 'Announce!', emoji: '📢', color: 'purple' },
    { date: new Date(2026, 1, 12), label: 'Second Trimester', emoji: '✨', color: 'blue', description: 'Start of second trimester (week 13)' },
